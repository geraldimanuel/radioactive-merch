...
<body class="overflow-x-hidden">
    ...
    <div class="grid justify-center">
        <div class="flex items-center gap-20 pt-[7rem]">
            ...
            <div id="indicators-carousel" class="relative w-[250px] h-[350px]" data-carousel="static">
                ...
                <div class="z-30 inline-flex gap-4 overflow-hidden justify-center mt-[20px]">
                    <img type="button" class="w-[50px] h-[70px] border-[1px] border-white" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0" src="images/merch1.jpg"/>
                    <img type="button" class="w-[50px] h-[70px] border-[1px] border-white" aria-current="true" aria-label="Slide 2" data-carousel-slide-to="1" src=" "/>
                    <img type="button" class="w-[50px] h-[70px] border-[1px] border-white" aria-current="true" aria-label="Slide 3" data-carousel-slide-to="2" src=" "/>
                    <img type="button" class="w-[50px] h-[70px] border-[1px] border-white" aria-current="true" aria-label="Slide 4" data-carousel-slide-to="3" src=" "/>
                </div>
                    
                <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                    <span class="inline-flex items-center justify-center w-10 h-10 rounded-full dark:group-hover:bg-gray-800/60">
