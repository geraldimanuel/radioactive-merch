...
<body class="overflow-x-hidden">
    ...
    <<<<<<< HEAD <div class="flex justify-center pb-[50px] pt-[200px] h-[800px]">
                        ...
                        <div class="w-full">
                            ...
                            @else
                                <table border="1" cellpadding="10"
                                    class="w-4/5 text-lg mr-[50px] ml-[50px] shadow-lg lg:w-full">
                                    <tr>
